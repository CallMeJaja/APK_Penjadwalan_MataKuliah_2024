Namespace Core
    ''' <summary>
    ''' Application Session Management - Singleton Pattern
    ''' </summary>
    Public Class AppSession
        ...
        ''' </summary>
        Public Sub SetUserSession(userID As String, username As String, level As String,
                                Optional kodeProdi As String = "", Optional namaProdi As String = "")
            Me.IsLoggedIn = True
            Me.UserID = userID
